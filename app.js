...
function openSelectedGroupColorPicker() {
  if (!state.selectedItemKey) return;
  const [groupIndex, itemIndex] = state.selectedItemKey;
  openGroupColorPicker(groupIndex, itemIndex);
}
